(function(){
  ...
  const allImages = [
    ...
    {src:'./Images/Gallery/plantation-2.jpg', alt:'Tree plantation'},
    {src:'./Images/Gallery/plantation-2.jpg', alt:'Plantation team'},
    {src:'./Images/Gallery/plantation-2.jpg', alt:'Watering saplings'},
    {src:'./Images/Gallery/plantation-2.jpg', alt:'Volunteers group'},
    {src:'./Images/Gallery/plantation-2.jpg', alt:'Serving meals'},
    {src:'./Images/Gallery/plantation-2.jpg', alt:'Raskbind Foundation'},
    {src:'./Images/Gallery/plantation-2.jpg', alt:'Raskbind Foundation logo'},
    {src:'./Images/Gallery/plantation-2.jpg', alt:'Community'},
    {src:'./Images/Gallery/plantation-2.jpg', alt:'Community'},
    {src:'./Images/Gallery/plantation-2.jpg', alt:'Community'},
    {src:'./Images/Gallery/plantation-2.jpg', alt:'Community'},
    {src:'./Images/Gallery/plantation-2.jpg', alt:'Community'},
    {src:'./Images/Gallery/plantation-2.jpg', alt:'Background'},
    {src:'./Images/Gallery/plantation-2.jpg', alt:'Raskbind Foundation'},
    {src:'./Images/Gallery/plantation-2.jpg', alt:'Raskbind Foundation'}
  ];
